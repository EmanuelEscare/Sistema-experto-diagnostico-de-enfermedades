                        ...
                        <tr>
                            ...
                            <td class="dropdown text-center">
                                ...
                                <ul class="dropdown-menu text-center">
                                    ...
                                    <li><a class="dropdown-item"
                                            wire:click="changeRole('{{ $user->id }}','{{ $user->getRoleNames()->first() }}', 'doctor')">{{ __('Doctor') }}</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            wire:click="changeRole('{{ $user->id }}','{{ $user->getRoleNames()->first() }}', 'recepcionista')">{{ __('Recepcionista') }}</a>
                                    </li>
                                </ul>
                            </td>
                            <td class="text-center">
                                <button wire:click="modalUpdateUser({{$user->id}})" class="btn btn-lg btn-warning"> Editar <i
